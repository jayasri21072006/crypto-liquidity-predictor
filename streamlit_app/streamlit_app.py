...
.stApp {background:rgba(255,255,255,0.95); padding:30px 40px; border-radius:12px;}
...
input_data = pd.DataFrame({
    ...
    'Close':[close_price],'Volume':[volume],'Market Cap':[market_cap],
    'SMA_5':[0],'EMA_12':[0],'RSI':[0],'MACD':[0]
})
